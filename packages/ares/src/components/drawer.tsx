...
const DrawerOverlay: React.FC<React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Overlay>> =
  React.forwardRef<
...
const DrawerContent: React.FC<React.ComponentPropsWithoutRef<typeof DrawerPrimitive.Content>> =
  React.forwardRef<
