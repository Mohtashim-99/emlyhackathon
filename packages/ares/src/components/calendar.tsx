    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          'size-(--cell-size) aria-disabled:opacity-50 p-0 select-none opacity-80 hover:opacity-100 border border-border',
        ...
        weekday: cn(
          'text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem] select-none flex items-center justify-center min-w-8',
